...
public class AdminHomePage extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        int order = 0;
        if(department != null){
            order = transactionService.getTotalTransactions(department);
        }
        long soldPrice = 0;
        int sumTrans = 0;
        long quantitySold = 0;
        ...
        for (Transactions a : list_trans) {
            ...
            if (StringUtils.removeAccent(x).equals(StringUtils.removeAccent(OrderStatus.DONE)) && a.getDepartment_id().equals(department)) {
